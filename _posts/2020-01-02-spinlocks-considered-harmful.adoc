...
To set thread priorities, we use https://docs.rs/thread-priority/0.1.1/thread_priority/[thread_priority] crate, which is a thin wrapper around around `pthread` APIs.
